...
[![26 tests that run and pass to illustrate correctness up to the specification of the tests](man/figures/testthat.png){width=4in}](https://github.com/ctesta01/nadir/tree/main/tests/testthat)
...
[![nadir package website screenshot](man/figures/website.png)](https://ctesta01.github.io/nadir)
